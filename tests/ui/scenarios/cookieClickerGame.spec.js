...
fixture("Cookie Clicker Game")
    .page`https://kim-crowe-2022-06-20-ui-test2.cookieclickertechtest.airelogic.com`;
...
test("a player can navigate back to home page from game page", async () => {
    ...
    await t
        .expect(getPageUrl())
        .eql(
            "https://kim-crowe-2022-06-20-ui-test2.cookieclickertechtest.airelogic.com/"
        );
...
test("a player can view their game and score on home page and reenter game via link", async () => {
    ...
    await t
        .expect(getPageUrl())
        .eql(
            `https://kim-crowe-2022-06-20-ui-test2.cookieclickertechtest.airelogic.com/game/${username}`
        )
        .expect(gamePage.welcomeMessage.innerText)
        .eql(`Hello ${username}`)
        .expect(gamePage.cookieCounter.innerText)
